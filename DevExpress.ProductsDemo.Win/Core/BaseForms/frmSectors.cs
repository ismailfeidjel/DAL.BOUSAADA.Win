...
{
    public partial class frmSectors : frmLookupBase<LookupItem>
    {
        private const string TableName = "sectors";
        private readonly LookupRepository _repo = new LookupRepository();

        protected override string EntityName => "المجال";
        ...
        protected override void Validate(LookupItem entity)
        {
            ...
            string error = ValidationHelper.FirstError(
                ...
                (isUnique, "يوجد مجال آخر بنفس الاسم.")
            );
